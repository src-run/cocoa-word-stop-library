...
use SR\Cocoa\Word\Stop\Driver\RanksGoogleDriver;

/**
 * @covers \SR\Cocoa\Word\Stop\Driver\AbstractDriver
 * @covers \SR\Cocoa\Word\Stop\Driver\RanksGoogleDriver
 */
class RanksGoogleDriverTest extends AbstractDriverTest
{
    /**
