...
use SR\Cocoa\Word\Stop\Driver\NltkDriver;

/**
 * @covers \SR\Cocoa\Word\Stop\Driver\AbstractDriver
 * @covers \SR\Cocoa\Word\Stop\Driver\NltkDriver
 */
class NltkDriverTest extends AbstractDriverTest
{
    /**
