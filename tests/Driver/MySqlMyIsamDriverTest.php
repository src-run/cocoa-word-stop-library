...
use SR\Cocoa\Word\Stop\Driver\MySqlMyIsamDriver;

/**
 * @covers \SR\Cocoa\Word\Stop\Driver\AbstractDriver
 * @covers \SR\Cocoa\Word\Stop\Driver\MySqlMyIsamDriver
 */
class MySqlMyIsamDriverTest extends AbstractDriverTest
{
    /**
