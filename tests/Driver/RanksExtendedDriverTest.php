...
use SR\Cocoa\Word\Stop\Driver\RanksExtendedDriver;

/**
 * @covers \SR\Cocoa\Word\Stop\Driver\AbstractDriver
 * @covers \SR\Cocoa\Word\Stop\Driver\RanksExtendedDriver
 */
class RanksExtendedDriverTest extends AbstractDriverTest
{
    /**
    ...
    {
        return new RanksExtendedDriver();
    }
}
